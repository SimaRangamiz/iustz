    ...
    void Attack(char command, int index)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                model->getEnemy().setStamina(newStamina);
            }
        }
    }
};
...
int main()
{
    ...
    cout << model->getEnemy().getHP() << endl
         << model->getEnemy().getStamina() << endl
         << model->getHuman().getHP() << endl
         << model->getHuman().getStamina() << endl;
}
